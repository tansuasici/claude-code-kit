...
│   │   ├── lib/                    # Shared hook library (json-parse, state-counter, project-commands, redact-secrets, roots — package/worktree/state roots, run-with-timeout, gate-state — per-file gate results)
