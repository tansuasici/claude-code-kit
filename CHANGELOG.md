...
## [1.9.0](https://github.com/tansuasici/claude-code-kit/compare/v1.17.2...v1.9.0) (2026-06-03)
...
* add DESIGN.md support for frontend projects ([dbbc6cd](https://github.com/tansuasici/claude-code-kit/commit/dbbc6cd416607dbcbc36e4a9f80bd94d214482be)), closes [#42](https://github.com/tansuasici/claude-code-kit/issues/42)
...
* add Glassworm unicode detection hook and template-based skill generation system ([98de4c9](https://github.com/tansuasici/claude-code-kit/commit/98de4c9cdf2640a2861f5bb96c8fb14104865f47))
...
* add observer loop detection hook ([fcab499](https://github.com/tansuasici/claude-code-kit/commit/fcab499ac010ccb31bad9390bae59163f5df16b6)), closes [#47](https://github.com/tansuasici/claude-code-kit/issues/47)
...
* add severity labels, anti-rationalization tables, error patterns, and MCP integration ([a0cef3d](https://github.com/tansuasici/claude-code-kit/commit/a0cef3db2b5fa649584a24e0ce2ee26f9a41675c))
...
* add structured product context files (mission, roadmap, tech-stack) ([bd39fa5](https://github.com/tansuasici/claude-code-kit/commit/bd39fa50300be921abf3dd8f579d3f8397937155)), closes [#45](https://github.com/tansuasici/claude-code-kit/issues/45)
* add timestamped feature spec folders and shape-spec skill ([c85a134](https://github.com/tansuasici/claude-code-kit/commit/c85a13433bf936b925367ca3e512e9d2e74dcb4a)), closes [#43](https://github.com/tansuasici/claude-code-kit/issues/43)
...
* add why-loop to skill extraction workflow ([295bee6](https://github.com/tansuasici/claude-code-kit/commit/295bee68b45037c061413b255cccde8e47fb275a)), closes [#44](https://github.com/tansuasici/claude-code-kit/issues/44)
...
* DESIGN.md, spec folders, product context, loop detection, why-loop ([3eedf69](https://github.com/tansuasici/claude-code-kit/commit/3eedf698a79718b1279fbc14796669a78ad62872))
...
* Glassworm unicode hook + template-based skill generation ([a6869f4](https://github.com/tansuasici/claude-code-kit/commit/a6869f44bebfc59c45386049bfced9f5b8efd974))
...
* severity labels, anti-rationalization tables, error patterns, MCP integration ([3eb9e32](https://github.com/tansuasici/claude-code-kit/commit/3eb9e32be9abb2173516075642b8f2a0ac30767a))
...
* add trailing newline to shared block files (markdownlint MD047) ([53d7c63](https://github.com/tansuasici/claude-code-kit/commit/53d7c63ef4774b31d21c51c7fb04c0ae4681c59c))
